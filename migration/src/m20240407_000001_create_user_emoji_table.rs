        ...
        manager
            .create_table(
                Table::create()
                    .primary_key(
                        Index::create()
                            .col(UserEmoji::UserId)
                            .col(UserEmoji::GuildId),
                    )
                    .table(UserEmoji::Table)
                    .if_not_exists()
                    .col(ColumnDef::new(UserEmoji::UserId).big_unsigned().not_null())
                    .col(ColumnDef::new(UserEmoji::GuildId).big_unsigned().not_null())
                    .col(ColumnDef::new(UserEmoji::Emoji).string().not_null())
                    .foreign_key(
                        ForeignKey::create()
